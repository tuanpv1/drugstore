...
<header role="banner">
        ...
        <div class="line">
            <div class="s-12 m-6 l-6">
                <div class="top-bar-contact">
                    <p class="text-size-12">Liên hệ: 0972.64.9696 | <a class="text-orange-hover" href="mailto:contact@sampledomain.com">tuantrylook@gmail.com</a></p>
                </div>
            </div>
            <div class="s-12 m-6 l-6">
                <div class="right">
    ...
    <nav class="background-white background-primary-hightlight">
        <div class="line">
            <div class="s-12 l-2">
                <a href="<?= Url::to(['site/index']) ?>" class="logo"><img style="width: 150px" src="<?=  Yii::$app->request->baseUrl; ?>/img/logo_free.png" alt="Trang chủ"></a>
            </div>
                        ...
                        <div class="line">
                            ...
                            <div class="margin">
                                <div class="s-12 m-12 l-4 margin-m-bottom">
                                    <a class="image-hover-zoom" href="/"><img src="<?=  Yii::$app->request->baseUrl; ?>/img/blog-04.jpg" alt=""></a>
                                </div>
        ...
        <div class="s-12 m-12 l-4 margin-m-bottom-2x">
            ...
            <div class="line">
                ...
                <div class="s-11 m-11 l-11 margin-bottom-10">
                    <p><b>Địa chỉ:</b> Ngõ 378 Mỹ Đình Từ Liêm Hà Nội</p>
                </div>
            </div>
            <div class="line">
                <div class="s-1 m-1 l-1 text-center">
                ...
                <div class="s-11 m-11 l-11 margin-bottom-10">
                    <p><a href="/" class="text-primary-hover"><b>E-mail:</b> tuantrylook@gmail.com</a></p>
                </div>
            </div>
            <div class="line">
                <div class="s-1 m-1 l-1 text-center">
