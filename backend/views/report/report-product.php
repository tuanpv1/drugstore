                    ...
                    <?php if ($report->dataProvider) { ?>
                        <?= GridView::widget([
                            ...
                            'columns' => [
                                ...
                                [
                                    'class' => '\kartik\grid\DataColumn',
                                    'label' => 'Số lượng SP vừa đặt FE',
                                    'value' => function ($model) {
                                        return $model->number_ordered1?$model->number_ordered1:0;
                                    },
                                    'pageSummary' => $report->content->sum('number_ordered1') ? $report->content->sum('number_ordered1')  : 0
                                ],
                                [
                                    'class' => '\kartik\grid\DataColumn',
                                    'label' => 'Doanh thu vừa đặt',
                                    'value' => function ($model) {
                                        return $model->total_ordered1?Product::formatNumber($model->total_ordered1).' VND':0;
                                    },
                                    'pageSummary' => $report->content->sum('total_ordered1') ?Product::formatNumber( $report->content->sum('total_ordered1')).' VND'  : 0
                                ],
                            ],
                            'panel' => [
